package com.andreabonatti92.models
...
class TicTacToeGame {
    ...
    // link player, represented by a char, and the respective socket
    ...
    fun connectPlayer(session: WebSocketSession): Char? {
        // 1st player always X, 2nd always O
        ...
        state.update {
            ...
            // check if the player had already a socket
